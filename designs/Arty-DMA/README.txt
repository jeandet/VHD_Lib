...
Design specifics
----------------
* The default configuration sets the system frequency to 80 MHz.
...
-bash-4.1$ grmon -digilent

  GRMON LEON debug monitor v3.0.9 64-bit eval version
  
  Copyright (C) 2018 Cobham Gaisler - All rights reserved.
  For latest updates, go to http://www.gaisler.com/
  Comments or bug-reports to support@gaisler.com
  
  This eval version will expire on 04/01/2019
...
grmon3> info sys
  ...
  ahbjtag0  Cobham Gaisler  JTAG Debug Link    
            AHB Master 2
  adev3     Unknown vendor  Unknown device    
            AHB Master 3
